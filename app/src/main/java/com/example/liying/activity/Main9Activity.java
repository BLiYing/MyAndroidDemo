...
public class Main9Activity extends AppCompatActivity implements SurfaceHolder.Callback , SensorEventListener {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            btnRestar.setOnClickListener(new View.OnClickListener() {
               ...
               /* if(mCamera != null){
                    ...
                    // mSurfaceView.scrollBy(10,10);
                    mContainer.animate().scaleX(0.4f).scaleY(0.7f);
                    // mContainer.animate().rotation(50);
                }
            });
                    ...
                    if (mCamera != null && mCameraID == Camera.CameraInfo.CAMERA_FACING_BACK){
                        mCamera.autoFocus(new Camera.AutoFocusCallback() {
                            ...
                            public void onAutoFocus(boolean success, Camera camera) {
                                if(success){
                                    Toast.makeText(Main9Activity.this,"对焦成功",Toast.LENGTH_SHORT).show();
                                }else{
                    ...
                    if(mCamera!= null){
                        mCamera.takePicture(null, null, new Camera.PictureCallback() {
                            ...
                            public void onPictureTaken(byte[] data, Camera camera) {
                                ...
                                File pictureFile2 = new File(path+ "focusdemo2.jpg");
...

                                {
                                    ...
                                    if (data != null && data.length > 0) {
                                        ...
                                        int rotation = (calculateCameraPreviewOrientation(Main9Activity.this) + mSensorRotation) % 360 ;
                                        ...
                                        saveBitmap(path+ "focusdemo2.jpg",result);
                                    } else {
                                        result = null;
                                    }
                                }
            ...
            mSensorManager = (SensorManager) Main9Activity.this.getSystemService(Activity.SENSOR_SERVICE);
        ...
        public void init(){
            if(mSurfaceView == null){
                ...
                WindowManager wm = (WindowManager) Main9Activity.this.getSystemService(Context.WINDOW_SERVICE);
        ...
        private void initCamera() {
            ...
            if (mCamera != null){
                ...
                int degree = calculateCameraPreviewOrientation(Main9Activity.this);
        ...
        private  void handleFocus(MotionEvent event, Camera camera) {
            ...
            camera.autoFocus(new Camera.AutoFocusCallback() {
                ...
                public void onAutoFocus(boolean success, Camera camera) {
                    ...
                    camera.setParameters(params);
                    if(success){
                        Toast.makeText(Main9Activity.this,"对焦区域对焦成功",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
